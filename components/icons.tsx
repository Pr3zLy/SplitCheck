...
export const HeroIllustration: React.FC<IconProps> = ({ className, ...props }) => (
    <svg className={className} viewBox="0 0 500 350" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <g transform="translate(60, 70) rotate(-10 100 100)" style={{ filter: 'url(#hero-shadow)' }}>
            ...
            <rect x="20" y="20" width="100" height="8" rx="4" className="fill-muted-foreground/30 dark:fill-border" />
            <rect x="20" y="40" width="160" height="6" rx="3" className="fill-muted-foreground/20 dark:fill-border opacity-70" />
            <rect x="20" y="55" width="130" height="6" rx="3" className="fill-muted-foreground/20 dark:fill-border opacity-70" />
            <rect x="20" y="70" width="160" height="6" rx="3" className="fill-muted-foreground/20 dark:fill-border opacity-70" />
            <rect x="20" y="95" width="80" height="8" rx="4" className="fill-muted-foreground/30 dark:fill-border" />
        ...
        <g style={{ filter: 'url(#hero-shadow)' }}>
            {/* Person 1 */}
            <circle cx="350" cy="90" r="25" className="fill-primary/10 dark:fill-secondary stroke-border" />
            <circle cx="350" cy="70" r="10" className="fill-background dark:fill-card"/>
            <path d="M335,85 a15,15 0 0,0 30,0" className="fill-primary/10 dark:fill-secondary stroke-border" strokeWidth="1"/>

            {/* Person 2 */}
            <circle cx="420" cy="175" r="25" className="fill-primary/10 dark:fill-secondary stroke-border" />
            <circle cx="420" cy="155" r="10" className="fill-background dark:fill-card"/>
            <path d="M405,170 a15,15 0 0,0 30,0" className="fill-primary/10 dark:fill-secondary stroke-border" strokeWidth="1"/>

            {/* Person 3 */}
            <circle cx="350" cy="260" r="25" className="fill-primary/10 dark:fill-secondary stroke-border" />
            <circle cx="350" cy="240" r="10" className="fill-background dark:fill-card"/>
            <path d="M335,255 a15,15 0 0,0 30,0" className="fill-primary/10 dark:fill-secondary stroke-border" strokeWidth="1"/>
        </g>
...
export const GithubIcon: React.FC<IconProps> = ({ className, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className={className} {...props}>
        <path d="M8 0a8 8 0 0 0-2.53 15.59c.4.07.55-.17.55-.38l-.01-1.42c-2.22.48-2.69-1.07-2.69-1.07-.36-.92-.88-1.17-.88-1.17-.72-.49.05-.48.05-.48.8.06 1.22.82 1.22.82.71 1.22 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.28.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48l-.01 2.2c0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8a8 8 0 0 0-8-8Z" />
    </svg>
);
